...
from .models.maskdino_hourglass_swin_large_384 import model
...
model.backbone.clustering_location=12
optimizer = get_config("common/optim.py").AdamW

# initialize checkpoint to be loaded
train.init_checkpoint = "/path/to/swin_large_patch4_window12_384_22kto1k.pth"
train.output_dir = "./output/maskdino_hourglass_swin_large_384_coco_panpoptic_seg_50ep"
